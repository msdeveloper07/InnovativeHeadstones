            ...
            <div class="hs-cat-main">
                ...
                <aside class="hs-cat-right-menu">
                    ...
                    <div class="filter-range">
                        ...
                        <input type="text" class="js-range-slider" name="my_range" value="" data-skin="round" data-type="double" data-min="100" data-max="10050" data-grid="false" />

                        <div class="price-range-inputs-grp">
                            <input name="minPrice" type="number" maxlength="4" class="from" value="100" />
                            <input name="maxPrice" type="number" maxlength="4" class="to" value="10050" />
                        </div>
                ...
                <div class="hs-cat-left">
                    <div class="hs-cat-main-p">
                        <p>
                            Our cross upright headstones are beautifully carved and come in many colors, all made from 100% natural premium and
                            exotic granite. Prices starting at $3,549.00 and include unlimited lettering and free freight anywhere in the Contiguous
                            US.
                        </p>
                    </div>
                    ...
                    <div class="hs-cat-result-grid">
                        ...
                        <!-- <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/cross-hs-1.jpg" alt="">                                    
                                </div>
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/cross-hs-2.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/cross-hs-3.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/cross-hs.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
...
<script>
    ...
    function filter(minPrice, maxPrice, sort) {
        ...
        $.ajax({
            ...
            method: 'POST',
            url: "/public/product-category/cross-headstones",
            data: {
                minPrice: minPrice,
                maxPrice: maxPrice,
                sort: sort,
            ...
            success: function(result) {
                ...
                function products(item, index) {
                    var appendProperty = `<a href="{{asset('product-category/cross-headstones/` + item.name + `')}}" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
