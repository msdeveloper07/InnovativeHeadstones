            ...
            <div class="hs-cat-main">
                ...
                <aside class="hs-cat-right-menu">
                    ...
                    <div class="filter-range">
                        ...
                        <div class="price-range-inputs-grp">
                            ...
                            <input name="maxPrice" type="number" maxlength="4" class="to" value="3000" />
                        </div>
                ...
                <div class="hs-cat-left">
                    <div class="hs-cat-main-p">
                        <p>
                            PhotoStones are memorials that have an engraved photo that cover most or all of the surface.
                        </p>
                    </div>
                    ...
                    <div class="hs-cat-result-grid">
                        ...
                        <!-- <a href="#" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
                                <img src="./assets/images/photostones-hs.jpg" alt="">
                            </div>
...
<script>
    ...
    function filter(minPrice, maxPrice, sort) {
        ...
        $.ajax({
            ...
            method: 'POST',
            url: "/public/product-category/photostones-engraved-headstones",
            data: {
                minPrice: minPrice,
                maxPrice: maxPrice,
                sort: sort,
            ...
            success: function(result) {
                ...
                function products(item, index) {
                    var appendProperty = `<a href="{{asset('product-category/photostones-engraved-headstones/` + item.name + `')}}" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
