...
<script>
    ...
    function filter(minPrice, maxPrice, sort) {
        ...
        $.ajax({
            ...
            method: 'POST',
            url: "/public/product-category/classic-upright-headstones",
            data: {
                minPrice: minPrice,
                maxPrice: maxPrice,
                sort: sort,
            ...
            success: function(result) {
                ...
                function products(item, index) {
                    var appendProperty = `<a href="{{asset('product-category/classic-upright-headstones/` + item.name + `')}}" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
