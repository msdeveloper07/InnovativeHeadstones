            ...
            <div class="hs-cat-main">
                ...
                <aside class="hs-cat-right-menu">
                    ...
                    <div class="filter-range">
                        ...
                        <input type="text" class="js-range-slider" name="my_range" value="" data-skin="round" data-type="double" data-min="1000" data-max="20000" data-grid="false" />
                ...
                <div class="hs-cat-left">
                    <div class="hs-cat-main-p">
                        <p>
                            Our heart shaped headstones are beautifully sculpted and come in many colors, all made from 100% natural premium and
                            exotic granite. Prices starting at $2,899.00 and include unlimited lettering and free freight anywhere in the Contiguous
                            US only.
                        </p>
                    </div>
                    ...
                    <div class="hs-cat-result-grid">
                        ...
                        <!-- <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/heart-hs-1.jpg" alt="">                                    
                                </div>
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/heart-hs-2.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/heart-hs-3.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/heart-hs-4.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/heart-hs-5.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
...
<script>
    ...
    function filter(minPrice, maxPrice, sort) {
        ...
        $.ajax({
            ...
            method: 'POST',
            url: "/public/product-category/heart-shaped-headstones",
            data: {
                minPrice: minPrice,
                maxPrice: maxPrice,
                sort: sort,
            ...
            success: function(result) {
                ...
                function products(item, index) {
                    var appendProperty = `<a href="{{asset('product-category/heart-shaped-headstones/` + item.name + `')}}" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
