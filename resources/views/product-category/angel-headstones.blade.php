            ...
            <div class="hs-cat-main">
                ...
                <div class="hs-cat-left">
                    <div class="hs-cat-main-p">
                        <p>
                            Our angel headstones are beautifully sculpted and come in many colors, all made from 100% natural premium and exotic
                            granite. Prices starting at $4,464.00 and include unlimited lettering and free freight anywhere in the Contiguous US
                            only.
                        </p>
                    </div>
                    ...
                    <div class="hs-cat-result-grid">
                        ...
                        <!-- <a href="#" class="hs-cat-result-grid-item">
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/angel-hs-2.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/angel-hs-3.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
                            ...
                            <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/angel-hs.jpg" alt="">                                    
                                </div>
                                <div class="hs-cat-result-grid-item-p">
                                    <p class="hs-cat-result-grid-item-detail">
...
<script>
    ...
    function filter(minPrice, maxPrice, sort) {
        ...
        $.ajax({
            ...
            method: 'POST',
            url: "/public/product-category/angel-headstones",
            data: {
                minPrice: minPrice,
                maxPrice: maxPrice,
                sort: sort,
            ...
            success: function(result) {
                ...
                function products(item, index) {
                    var appendProperty = `<a href="{{asset('product-category/angel-headstones/` + item.name + `')}}" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
