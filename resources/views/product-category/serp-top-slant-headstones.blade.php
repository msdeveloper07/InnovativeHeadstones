            ...
            <div class="hs-cat-main">
                ...
                <div class="hs-cat-left">
                    <div class="hs-cat-main-p">
                        <p>
                            The elegant serpentine top slant headstones come in many colors and are made from 100% natural premium and exotic
                            granite and handcarved with care. Slant marker prices starting at $1,449.00 and include unlimited lettering and free
                    ...
                    <div class="hs-cat-result-grid">
                        ...
                        <!-- <a href="#" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
                                <img src="./assets/images/serp-top-hs.jpg" alt="">
                            </div>
                        ...
                        <a href="#" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
                                <img src="./assets/images/serp-top-slant-2.jpg" alt="">
                            </div>
                            <div class="hs-cat-result-grid-item-p">
                                <p class="hs-cat-result-grid-item-detail">
                        ...
                        <a href="#" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
                                <img src="./assets/images/serp-top-slant-3.jpg" alt="">
                            </div>
                            <div class="hs-cat-result-grid-item-p">
                                <p class="hs-cat-result-grid-item-detail">
                        ...
                        <a href="#" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
                                <img src="./assets/images/serp-top-slant-4.jpg" alt="">
                            </div>
                            <div class="hs-cat-result-grid-item-p">
                                <p class="hs-cat-result-grid-item-detail">
...
<script>
    ...
    function filter(minPrice, maxPrice, sort) {
        ...
        $.ajax({
            ...
            method: 'POST',
            url: "/public/product-category/serp-top-slant-headstones",
            data: {
                minPrice: minPrice,
                maxPrice: maxPrice,
                sort: sort,
            ...
            success: function(result) {
                ...
                function products(item, index) {
                    var appendProperty = `<a href="{{asset('product-category/serp-top-slant-headstones/` + item.name + `')}}" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
