            ...
            <div class="hs-cat-main">
                ...
                <aside class="hs-cat-right-menu">
                    ...
                    <div class="filter-range">
                        <input type="text" class="js-range-slider" name="my_range" value="" data-skin="round" data-type="double" data-min="100" data-max="3000" data-grid="false" />

                        <div class="price-range-inputs-grp">
                            <input name="minPrice" type="number" type="number" maxlength="4" class="from" value="100" />
                            <input name="maxPrice" type="number" type="number" maxlength="4" class="to" value="3000" />
                        </div>
                ...
                <div class="hs-cat-left">
                    <div class="hs-cat-main-p">
                        <p>
                            Our pillow top headstones come in many colors and are made of 100% natural premium and exotic granite. Soft angles
                            delightfully reveal the polished granite top surface and all the fine handcarved sentiments of your loved one. Standard
                            and custom sizes are available. Prices starting at $834.00 and include unlimited lettering and free freight anywhere in
                            the Contiguous US only.
                        </p>
                    </div>
                    ...
                    <div class="hs-cat-result-grid">
                        ...
                        <!-- <a href="#" class="hs-cat-result-grid-item">
                                <div class="hs-cat-result-grid-item-img">
                                    <img src="./assets/images/pillow-hs.jpg" alt="">                                    
                                </div>
...
<script>
    ...
    function filter(minPrice, maxPrice, sort) {
        ...
        $.ajax({
            ...
            method: 'POST',
            url: "/public/product-category/pillow-top-headstones",
            data: {
                minPrice: minPrice,
                maxPrice: maxPrice,
                sort: sort,
            ...
            success: function(result) {
                ...
                function products(item, index) {
                    var appendProperty = `<a href="{{asset('product-category/pillow-top-headstones/` + item.name + `')}}" class="hs-cat-result-grid-item">
                            <div class="hs-cat-result-grid-item-img">
