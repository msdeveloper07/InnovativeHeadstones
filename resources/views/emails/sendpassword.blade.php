<html>
    <head>
        <title>Account Password Mail</title>
        <style>
                  ...
                  <tr>
                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                        Hi {{$data['email']}},</p>
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">We're excited to welcome you to Innovative Headstone! As requested, we're providing you with a temporary password to access your account.</p>
                      <br />
                      ...
                      <br>
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"> We take your account's security seriously, and we strongly advise against sharing your password with anyone. Keep it confidential and use it solely for the purpose of accessing your account.                        <br></p>
                      <br>
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"> Thank you for using our service. We appreciate your continued support.</p>
                      <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                        Best regards, <br>
                        Team Innovative Headstone</p>
                    </td>
                  </tr>
                </table>
              </td>
              ...
              <tr>
                <td align="center" class="content-block powered-by" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px !important; color: #999999; text-align: center;">
                  <div style="text-align:center;padding: 0 20px">
                    <a href="#" style="color: #999999; font-size: 12px !important; text-decoration: none;">Innovative Headstone</a> &copy; 2020
                  </div>
                </td>
              </tr>
            </table>
